Práctica comando CASE
    ...
    Vamos a poner dentro el nombre del usuario con el que nos hemos conectado. Para saberlo, usamos la función USER de Oracle que devuelve el nombre del usuario con el que estamos conectados
    (Recuerda que en Oracle no hace falta poner paréntesis si una función no tiene argumentos) usuario:=user
    ...
    BEGIN
        ...
        CASE usuario
            ...
            ELSE dbms_output.put_line('suario no autorizado');
        END CASE;
    END;